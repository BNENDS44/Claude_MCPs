...
5. Return a markdown table — top 10 — with the score, name, CATS ID, location, current employer, criteria status, and a 1-line "why this score" with evidence sources (work history, recruiter note, resume page).
